...
def movies_by_genre(genre):
    result = (f"""select title, description
    from netflix
...
#print(cast_partners('Jack Black', 'Dustin Hoffman'))


"""поиск по типу кино/сериал"""
